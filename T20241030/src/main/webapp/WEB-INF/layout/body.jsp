        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="../images/과테말라 안티구아.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        <div class="small mb-1">P001</div>
                        <h1 class="display-5 fw-bolder">과테말라 안티구아</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">$45.00</span>
                            <span>$40.00</span>
                        </div>
                        <p class="lead">아주 맛있는 과테말라 안티구아 입니다</p>
                        <div class="d-flex">
